...
function Navbar() {
    return (
        <div className="Navbar" style={{ backgroundColor: '#13385d' }}>
            ...
            <hr className="mx-5" style={{ borderColor: 'white', borderWidth: '4px' }} /> {/* Adding the line here */}

            <nav className="navbar navbar-expand-lg px-5" >
                <div className="container-fluid">
                    <a className="navbar-brand" href="/">
                        <img src={Banner} alt="Navbar Banner" style={{ width: '550px', height: '50px' }} />
                    </a>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0 d-flex justify-content-end">
                        ...
                        <li className="nav-item">
                            <a className="nav-link text-white" href="/townships">Townships</a>
                        </li>
                        <li className="nav-item">
